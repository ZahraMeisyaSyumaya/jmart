...
import com.zahraJmartRK.*;
import com.zahraJmartRK.ObjectPoolThread;
import com.zahraJmartRK.Payment;
...
public class PaymentController implements BasicGetController<Payment> {
    ...
    public static @JsonAutowired(value = Payment.class, filepath = "C:\\Users\\Zahra\\repo_baru\\jmart\\src\\main\\payment.json")
                ...
                for(Product product : ProductController.productTable){
                    if(product.accountId == productId){
                        ...
                        if(account.balance >= totalPay){
                            ...
                            newPayment.history.add(new Payment.Record(Invoice.Status.WAITING_CONFIRMATION, "WAITING CONFIRMATION"));
