...
public class Algorithm {
    ...
    public static <T> int cnt(T [] array, T value)
    {
        int cnt = 0;
    ...
    public static <T> int cnt(Iterable<T> iterable, T value)
    {
        int cnt = 0;
    ...
    public static <T> int cnt(Iterator<T> iterator, T value)
    {
        int cnt = 0;
    ...
    public static <T> int cnt(T [] array, Predicate<T> pred)
    {
        int cnt = 0;
    ...
    public static <T> int cnt(Iterable<T> iterable, Predicate<T> pred)
    {
        int cnt = 0;
    ...
    public static <T> int cnt(Iterator<T> iterator, Predicate<T> pred)
    {
        int cnt = 0;
        while(iterator.hasNext()){
